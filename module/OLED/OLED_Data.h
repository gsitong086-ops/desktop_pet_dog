...
extern const uint8_t rosydoedian[];
/*按照上面的格式，在这个位置加入新的图像数据声明*/
extern const uint8_t SZTUImg1[];
extern const uint8_t CantabImg[];
extern const uint8_t OSHAImg[];
...
extern const uint8_t BMPaa[];
extern const uint8_t BMPbb[];
extern const uint8_t BMPcc[];
extern const uint8_t BMPdd[];
extern const uint8_t BMPee[];
